// 산호초 그룹 1
var im = ["san/s1", "san/s2",  "san/s3", "san/s4", "san/s5", "san/s6", "san/s7", "san/s8", "san/s9", "san/s10" ];
var container = document.getElementById("image-container");

for (var i = 0; i < 75; i++) {
  var c = document.createElement("img");
  c.src = im[randomBH(0, 9)] + ".png";
  ...
  c.style.opacity = randomBH(30, 60) / 100; // 랜덤한 opacity 설정
...
for (var i = 0; i < 80; i++) {
  ...
  e.src = im[randomBH(0, 9)] + ".png";
  e.style.width = randomBH(10, 45) + "px";
  e.style.height = "auto";
  e.className = "pp";
  e.style.opacity = randomBH(30, 60) / 100; // 랜덤한 opacity 설정
...
for (var i = 0; i < 35; i++) {
  ...
  f.src = im[randomBH(0, 9)] + ".png";
  f.style.width = randomBH(50, 100) + "px";
  f.style.height = "auto";
  f.className = "pp";
  f.style.opacity = randomBH(30, 70) / 100; // 랜덤한 opacity 설정
...
// var im = ["san/s1", "san/s2",  "san/s3", "san/s4", "san/s5", "san/s6", "san/s7", "san/s8", "san/s9" ];
// var container = document.getElementById("image-container3");

// for (var i = 0; i < 40; i++) {
//   var h = document.createElement("img");
//   h.src = im[randomBH(0, 8)] + ".png";
